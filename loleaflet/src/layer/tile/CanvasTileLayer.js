...
/* global app L CanvasSectionContainer CanvasOverlay CSplitterLine CStyleData $ _ isAnyVexDialogActive CPointSet CPolyUtil CPolygon Cursor CCellCursor CCellSelection PathGroupType Uint8ClampedArray Uint8Array */
	...
	_onTileMsg: function (textMsg, img) {
		...
		if (tileMsgObj.id !== undefined) {
			...
			if (this._map._canvasDevicePixelGrid)
				// loleaflet/test/pixel-test.png - debugging pixel alignment.
