...
L.Control.MobileBottomBar = L.Control.extend({
	...
	getToolItems: function(docType) {
		if (docType == 'text') {
			return [
				{type: 'button',  id: 'showsearchbar',  img: 'search', hint: _('Show the search bar'), context: ['default', 'Text', 'Table', 'Graphic']},
				{type: 'break', context: ['default', 'Text', 'Table', 'Graphic']},
				// context: ['default', 'Text', 'Table']
				{type: 'button',  id: 'bold',  img: 'bold', hint: _UNO('.uno:Bold'), uno: '.uno:Bold', context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'italic', img: 'italic', hint: _UNO('.uno:Italic'), uno: '.uno:Italic', context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'underline',  img: 'underline', hint: _UNO('.uno:Underline'), uno: '.uno:Underline', context: ['default', 'Text', 'Table']},
				{type: 'break', id: 'breakcolor', context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'fontcolor', img: 'textcolor', hint: _UNO('.uno:FontColor'), freemiumUno: '.uno:FontColor', context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'backcolor', img: 'backcolor', hint: _UNO('.uno:BackColor'), freemiumUno: '.uno:BackColor', context: ['default', 'Text', 'Table']},
				...
				{type: 'break', id: 'breakalign-text', context: ['default', 'Text']},
				...
				{type: 'menu', id: 'align-table', img: 'alignblock', hint: _UNO('.uno:TextAlign'), freemiumUno: '.uno:TextAlign', context: ['Table'],
					items: [
				...
				{type: 'button',  id: 'defaultnumbering-text',  img: 'numbering', hint: _UNO('.uno:DefaultNumbering', '', true),uno: '.uno:DefaultNumbering', disabled: true, context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'defaultbullet-text',  img: 'bullet', hint: _UNO('.uno:DefaultBullet', '', true), uno: '.uno:DefaultBullet', disabled: true, context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'incrementindent-text',  img: 'incrementindent', hint: _UNO('.uno:IncrementIndent', '', true), uno: '.uno:IncrementIndent', disabled: true, context: ['default', 'Text', 'Table']},
				{type: 'button',  id: 'decrementindent-text',  img: 'decrementindent', hint: _UNO('.uno:DecrementIndent', '', true), uno: '.uno:DecrementIndent', disabled: true, context: ['default', 'Text', 'Table']},
				// context: ['Table']
